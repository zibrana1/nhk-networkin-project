@extends('admin.layouts.app', ['activePage' => 'Gestion employé', 'title' => 'NHK networking', 'navName' => 'Clients/create', 'activeButton' => 'laravel'])
@section('content')
    <div class="container">
        <h2 class="mt-5">Enregistrer un client</h2>
