@extends('admin.layouts.app', ['activePage' => 'dashboard', 'title' => 'NHK networking', 'navName' => 'Dashboard', 'activeButton' => 'laravel'])
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card ">
                        <div class="card-header ">
                            <h4 class="card-title">{{ __('2023 Sales') }}</h4>
                        ...
                        <div class="card-footer ">
                            <div class="legend">
                                <i class="fa fa-circle text-info"></i> {{ __('Dell modes') }}
