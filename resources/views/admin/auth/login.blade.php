@extends('admin.layouts.app', ['activePage' => 'login', 'title' => 'NHK networking login', 'activeButton' => 'laravel', 'navName'=>'Dashboard'])
                            ...
                            <div class="card-body ">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-14">
                                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email', 'honore@gmail.com') }}" required autocomplete="email" autofocus>
                                ...
                                <div class="card-footer ml-auto mr-auto">
                                    <div class="container text-center" >
                                        <button type="submit" class="btn btn-warning btn-wd">{{ __('Se connecter') }}</button>
                                    </div>
                                    <div class="d-block">
